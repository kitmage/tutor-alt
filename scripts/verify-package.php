...
if(array_keys($roots)!==['tutor']||false===$zip->locateName('tutor/tutor.php')){fwrite(STDERR,"Package must contain only tutor/ and tutor/tutor.php\n");exit(1);}echo "PASS: tutor/tutor.php package identity verified\n";

...
$checks=['classes/Course.php'=>["PRICE_TYPE_ENTITLEMENT  = 'entitlement'",'is_course_entitlement_only'],'tutor.php'=>['Update URI: https://github.com/kitmage/tutor-alt','TUTOR_VERSION','TUTOR_FILE','is_readable( $tutor_autoloader )',"'TUTOR\\\\'                         => __DIR__ . '/classes/'"],'assets/src/js/v3/entries/course-builder/services/course.ts'=>["'free' | 'paid' | 'entitlement'"],'kitmage/entitlements/Database/Migrator.php'=>['UNIQUE KEY source_item','UNIQUE KEY batch_user'],'kitmage/entitlements/Service/ReservationService.php'=>['entitlements_used+entitlements_reserved<entitlements_total','START TRANSACTION']];
